...
let nex_col = document.getElementById('nex'),
    sel_col = document.getElementById('sel')

nex_col.addEventListener('click', function (){
    if (sel_col.value === "0") {
        alert('please Select College')
    }else {
        nex_col.setAttribute('href','past-code.html')
    }
})
